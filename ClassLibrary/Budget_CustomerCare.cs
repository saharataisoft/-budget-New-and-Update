...
namespace BudgetCBL
{
    public partial class Budget_CustomerCare
    {
        ...
        public Budget_CustomerCare()
        {
        }
        public Budget_CustomerCare(string sConnectionString)
        {
        ...
        public bool add()
        {
            ...
            try
            {
                string sSQL = @"INSERT INTO CustomerCare 
                            (CustomerCareOID,Enable,Seq,FileName,BannerFileName,Title,ShortDes,Descriptions
                ...
                sqlParam[0] = new SqlParameter("@CustomerCareOID", SqlDbType.UniqueIdentifier);
                sqlParam[0].Value = this.CustomerCareOID;
        ...
        public bool update()
        {
            ...
            try
            {
                string sSQL = @"UPDATE CustomerCare SET 
                    ...
                    WHERE CustomerCareOID=@CustomerCareOID";
                SqlParameter[] sqlParam = new SqlParameter[23];
                sqlParam[0] = new SqlParameter("@CustomerCareOID", SqlDbType.UniqueIdentifier);
                sqlParam[0].Value = this.CustomerCareOID;
                sqlParam[1] = new SqlParameter("@Enable", SqlDbType.Bit);
