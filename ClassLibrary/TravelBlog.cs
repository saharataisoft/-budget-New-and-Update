...
namespace BudgetCBL
{
    public partial class TravelBlog
    {
        ...
        public TravelBlog(string sConnectionString)
        {
            ConnectionString = sConnectionString;
        }

        public List<TravelBlog> SelectAll(string PrefixTable)
        {
            List<TravelBlog> TravelBlogList = null;
            try
            {
                ...
                {
                    TravelBlogList = new List<TravelBlog>();
                    TravelBlog blog = null;
        ...
        public TravelBlog SelectByOID(string PrefixTable, Guid guidTravelBlogOID)
        {
            TravelBlog blog = null;
            try
            {
