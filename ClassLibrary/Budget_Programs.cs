...
namespace BudgetCBL
{
    public partial class Budget_Programs
    {
        ...
        public Budget_Programs(string sConnectionString)
        {
        ...
        public bool add()
        {
            ...
            try
            {
                string sSQL = @"INSERT INTO Programs 
                            (ProgramOID,Enable,Seq,FileName,BannerFileName,Title,ShortDes,Descriptions
                ...
                sqlParam[0] = new SqlParameter("@ProgramOID", SqlDbType.UniqueIdentifier);
                sqlParam[0].Value = this.ProgramOID;
        ...
        public bool update()
        {
            ...
            try
            {
                string sSQL = @"UPDATE Programs SET 
